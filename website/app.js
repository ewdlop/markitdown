const translations = {
    zh: {
        ...
        limitationsReasonIntro: '⚠️ AI 生成 Disclaimer：以下限制說明涵蓋瀏覽器版無法支援進階格式的原因。',
    ...
    en: {
        ...
        limitationsReasonIntro: '⚠️ AI-generated 聲明: the explanation below outlines why the browser build cannot support advanced formats.',
